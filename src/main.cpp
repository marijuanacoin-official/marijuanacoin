...
unsigned int nStakeMaxAge = 100 * 24 * 60 * 60;  
...
const string strMessageMagic = "Marijuanacoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees) 
{
    ...
    else if (pindexBest->nHeight+1 < 25000)
    {
      nSubsidy = 0.01 * COIN;
      return nSubsidy + nFees;
    }
    
	else if (pindexBest->nHeight+1 < 2000000)
    {
      nSubsidy = 1.5 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Marijuanacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "16th of January 2017 - Marijuanacoin Genesis";
        CTransaction txNew;
        txNew.nTime = 1484563220;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484563220;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2299781;
		if(fTestNet)
        {
            block.nNonce   = 0; //Testnet comes later
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xebc3bf478b9c0542138314725c272ae5ee88209ece269e725257efaaee8cc03b"));
...
unsigned char pchMessageStart[4] = { 0xb2, 0xb4, 0xa2, 0xa3 };
