	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 600);
    setWindowTitle(tr("Marijuanacoin") + " - " + tr("Version: 1.0.0.1"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Marijuanacoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Marijuanacoin"), this);
    aboutAction->setStatusTip(tr("Show information about Marijuanacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Marijuanacoin"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Marijuanacoin top-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Marijuanacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Marijuanacoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("Marijuanacoin Network<br><br>Connections: <b>%n</b>", "", count));
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    {
        labelStakingIcon->setToolTip(tr("You are not minting MAR: <b>Your wallet is locked</b><br>Marijuanacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (vNodes.empty())
    {
        labelStakingIcon->setToolTip(tr("You are not minting MAR: <b>Your wallet is offline</b><br>Marijuanacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (IsInitialBlockDownload())
    {
        labelStakingIcon->setToolTip(tr("You are not minting MAR: <b>Your wallet is syncing with the Marijuanacoin network</b><br>Marijuanacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (!nWeight)
    {
        labelStakingIcon->setToolTip(tr("You are not minting MAR: <b>You don't have mature coins</b><br>Marijuanacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    ...
    {	
        ...
        //labelStakingIcon->setToolTip(tr("You are minting MAR: <b>Happy Staking!</b><br><br>Marijuanacoin Network Weight: <b>%1</b><br><br>My Wallet Weight: <b>%2</b><br><br>My Network Weight Share: <b>%3%</b><br><br>Estimated Next Stake: <b>%4</b><br><br>MultiSend: <b>%5</b>").arg(nNetworkWeight).arg(nWeight).arg(nPercent).arg(text).arg(fMultiSend ? tr("Active"):tr("Inactive")));
		labelStakingIcon->setToolTip(tr("You are minting MAR: <b>Happy Staking!</b><br><br>Marijuanacoin Network Weight: <b>%1</b><br><br>My Wallet Weight: <b>%2</b><br><br>Estimated Next Stake: <b>%4</b><br><br>MultiSend: <b>%5</b>").arg(nNetworkWeight).arg(nWeight).arg(text).arg(fMultiSend ? tr("Active"):tr("Inactive")));
    }
    else
    {
        labelStakingIcon->setToolTip(tr("You are not minting MAR.<br>Marijuanacoin Network Weight: <b>%1</b>").arg(nNetworkWeight));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Marijuanacoin address or malformed URI parameters."));
    }
...
{
    if (!fUseMarijuanacoinTheme)
        return;

    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Marijuanacoin.qss";
