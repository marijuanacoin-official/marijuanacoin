    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the Marijuanacoin network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the Marijuanacoin network") + ")");
	ui->labelNetworkStatus->setText("(" + tr("Out of sync with the Marijuanacoin network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("MAR")
    updateDisplayUnit();
}
